...
Item {
    ...
    Canvas {
        ...
        width: 350
        height: 50
        property int fuelTank: CarEmulator.fuelTank
        onPaint: {
            var ctx = getContext("2d");

            var grd = ctx.createLinearGradient(250, 10, 250, 35);

            var currentFuel = (CarEmulator.fuelTank / 10000);
            ...
            // When tank capacity is falling below 20% turn progressbar color from green to red
            if (currentFuel < 0.2) {
